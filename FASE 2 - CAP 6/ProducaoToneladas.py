...
# Generate a line plot for 'Produção (Toneladas)' over time
plt.figure(figsize=(10, 6))
plt.plot(df['Mês'], df['Produção (Toneladas)'], marker='o', color='green')
plt.title('Produção (Toneladas) ao longo do tempo')
plt.xlabel('Mês')
